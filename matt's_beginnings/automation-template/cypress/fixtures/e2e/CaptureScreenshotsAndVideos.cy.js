...
describe('Screenshot and Video Capture', () => {
    ...
    it('should capture screenshots with timestamps', () => {
        ...
        cy.wait(4000);
        //cy.get("body > div.standard-section.homepage-hero-section.white > div > div > div.column-2.w-col.w-col-6.w-col-tiny-tiny-stack > h1").screenshot(elementScreenshotName);
    });
});