describe('Form Submission Test', () => {
    it('should fill out and submit the form', () => {
      ...
      cy.get('input[name="name"]').type('john doe');                       // Enter name
      cy.get('input[name="email"]').type('email@example.com');             // Enter email
      cy.get('input[name="Company"]').type('enter company name');          // Enter company name
